...
import { ShoppingCart, Filter, BookOpen, Wind, Headphones, Store, X, Trash2, Plus, Minus, Sparkles, Brain, Trophy, Target, Settings, Award, Menu } from "lucide-react"
import { useState } from "react"
import { motion, AnimatePresence } from "framer-motion"
import { toast } from "sonner"
import { Head, Link, usePage } from "@inertiajs/react"
import { mentoring, leaderboard as leaderboardRoute, missions, shop as shopRoute, profile } from "@/routes"
...
export default function ShopPage() {
  ...
  const quickActions = [
    { icon: Brain, label: "Belajar", color: "", href: mentoring().url, active: false },
    { icon: Trophy, label: "Skor", color: "", href: leaderboardRoute().url, active: false },
    { icon: Target, label: "Misi", color: "", href: missions().url, active: false },
    { icon: ShoppingCart, label: "Toko", color: "bg-gradient-to-r from-purple-500 to-pink-500", href: shopRoute().url, active: true },
    { icon: Settings, label: "Profil", color: "", href: profile().url, active: false },
